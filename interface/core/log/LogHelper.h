...
#define X3LOG_DEBUG(msg)  \
    X3LOG_EVENT_(msg, x3::logType_Debug, __FILE__, __LINE__)
...
#define X3LOG_DEBUG2(name, extra)     \
    X3LOG_EVENT_2(name, extra, x3::logType_Debug, __FILE__, __LINE__)
...
#define X3LOG_INFO(msg)   \
    X3LOG_EVENT_(msg, x3::logType_Info, __FILE__, __LINE__)
...
#define X3LOG_INFO2(name, extra)  \
    X3LOG_EVENT_2(name, extra, x3::logType_Info, __FILE__, __LINE__)
...
#define X3LOG_WARNING(msg)        \
    X3LOG_EVENT_(msg, x3::logType_Warning, __FILE__, __LINE__)
...
#define X3LOG_WARNING2(name, extra)   \
    X3LOG_EVENT_2(name, extra, x3::logType_Warning, __FILE__, __LINE__)
...
#define X3LOG_ERROR(msg)  \
    X3LOG_EVENT_(msg, x3::logType_Error, __FILE__, __LINE__)
...
#define X3LOG_ERROR2(name, extra)     \
    X3LOG_EVENT_2(name, extra, x3::logType_Error, __FILE__, __LINE__)
...
#define X3LOG_FATAL(msg)      \
    X3LOG_EVENT_(msg, x3::logType_Fatal, __FILE__, __LINE__)
...
#define X3LOG_FATAL2(name, extra)     \
    X3LOG_EVENT_2(name, extra, x3::logType_Fatal, __FILE__, __LINE__)
...
public:
    ...
    */
    ...
    {
        x3::Object<x3::ILogManager> manager(x3::CLSID_LogManager);
        if (manager)
        {
            manager->PushGroup(msg, extra, file, line);
        }
    }
...
#define X3LOG_EVENT_(msg, type, file, line)                     \
    ...
    {                                                           \
        std::wostringstream _buf;                               \
        _buf << msg;                                            \
        manager->WriteLog(type, _buf.str().c_str(), L"", file, line); \
    }} while (0)
...
#define X3LOG_EVENT_2(name, extra, type, file, line)            \
    ...
    {                                                           \
        std::wostringstream _buf;                               \
        _buf << extra;                                          \
        manager->WriteLog(type, name, _buf.str().c_str(), file, line); \
    }} while (0)
...
/*!
    ...
    \param type logging type, see LogType.
    \param file source file name, __FILE__
    \param line code line, __LINE__
*/
