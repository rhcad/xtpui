/*! \file IConfigSection.h
 *  \brief Define the configure data node interface: IConfigSection
...
/*! Use ConfigSection instead of using this interface.\n
    ...
    \see ConfigSection, IConfigData
*/
class IConfigSection : public IObject
{
public:
    X3DEFINE_IID(IConfigSection);

    //! Return the owner object.
    virtual IConfigData* GetData() const = 0;
