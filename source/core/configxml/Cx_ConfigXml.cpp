...
XMLDOMElementPtr ConfigXmlImpl::GetParentNode(IConfigSection* parent,
                                              std::wstring& strSection)
{
    ...
    if (parent)
    {
        ...
        ASSERT_MESSAGE(p != NULL, "type mismatch: IConfigSection");
...
IConfigData* Cx_ConfigXml::GetData()
{
    return this;
}
...
AnyObject Cx_ConfigXml::GetSection(const wchar_t* name, bool autoCreate)
{
    Object<IConfigSection> pIFRet(clsidXmlSection);
    ...
    return AnyObject(pIFRet);
}

AnyObject Cx_ConfigXml::GetSection(IConfigSection* parent,
                                const wchar_t* name,
...
long Cx_ConfigXml::GetSectionCount(IConfigSection* parent,
                                   const wchar_t* name)
{
    std::wstring strName (name ? name : L"");
    XMLDOMElementPtr xmlParent = m_pImpl->GetParentNode(parent, strName);
...
AnyObject Cx_ConfigXml::GetSectionByIndex(IConfigSection* parent, 
...
AnyObject Cx_ConfigXml::GetParentSection(IConfigSection* sec)
{
...
AnyObject Cx_ConfigXml::AddSection(IConfigSection* parent,
                                const wchar_t* name)
{
    std::wstring strName (name ? name : L"");
    Object<IConfigSection> pIFRet(clsidXmlSection);
...
bool Cx_ConfigXml::RemoveSection(IConfigSection* sec)
{
    bool bRet = false;
...
long Cx_ConfigXml::RemoveChildren(IConfigSection* parent,
                                  const wchar_t* name,
                                  const wchar_t* attrName,
                                  ULONG attrValue)
{
