...
void CMainMDIFrame::OnDestroy()
{
    CMainFrame::OnDestroy();
    CXTPMDIFrameWnd::OnDestroy();
}

BOOL CMainMDIFrame::OnCmdMsg(UINT id, int nCode, void* pExtra, 
                             AFX_CMDHANDLERINFO* pInfo)
{
    return CMainFrame::OnCmdMsg(id, nCode, pExtra, pInfo)
        || CXTPMDIFrameWnd::OnCmdMsg(id, nCode, pExtra, pInfo);
}
...
LRESULT CMainMDIFrame::OnDockingPaneNotify(WPARAM wParam, LPARAM lParam)
{
